...
import { readClient, role, addrs, gql, tx, explorerAddr, activeChain } from "@aqua-solvent/core";
...
export async function attestBooks(): Promise<number> {
  ...
  const bookAddr = book ?? (await import("@aqua-solvent/core")).readManifest().contracts.solventBook.address as Hex;
